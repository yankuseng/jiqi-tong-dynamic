      ...
      <main className="terms-content">
        <div className="container">
          <div className="terms-card">
            <h1 className="page-title">用户服务协议与社区准则</h1>
            <p className="terms-meta">最后更新日期：2026年5月</p>
            ...
            <section className="terms-section">
              ...
              <div>
                ...
                <p>· 访问 <Link href="/report" className="link-primary">企业申诉页面</Link> 提交申诉<br />· 平台将在 72 小时内处理您的申诉<br />· 提供充分证据的内容（如不实信息、隐私泄露），将在核实后立即删除<br />· 企业有权在对应点评下方发表公开回应</p>
              </div>
            </section>
            ...
            <div className="terms-footer">
              <p className="terms-meta">© 2024-2026 济企通 JiqiTong.com | 济南求职避坑指南</p>
            </div>
          </div>
        </div>
      </main>
